...
function fill_str_attr(aStrings, nIdGrupa, cNazGrupa)
...
f01_create_index("1", "STR(ID,10,0)", SIFPATH + "STRINGS" )
f01_create_index("2", "OZNAKA+STR(ID,10,0)", SIFPATH + "STRINGS" )
f01_create_index("3", "OZNAKA+STR(VEZA_1,10,0)+STR(ID,10,0)", SIFPATH + "STRINGS" )
f01_create_index("4", "OZNAKA+STR(VEZA_1,10,0)+NAZ", SIFPATH + "STRINGS" )
f01_create_index("5", "OZNAKA+STR(VEZA_1,10,0)+STR(VEZA_2,10,0)", SIFPATH + "STRINGS" )
