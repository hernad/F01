 ...
 *   P  - Pitanje prilikom poziva stampe DelphiRB ili obicni TXT
 */
...
if fdelphiRb
   ...
   if IzFmkIni("FAKT","Opcine","N",SIFPATH)=="D"
	...
	IF IzFMKINI("FAKT","KupacDesno","N",KUMPATH)=="D"
    		...
    		? space(5+38),gPB_ON+"����������"+IF(cIdTipDok=="06","KONSIGNATOR:","������������")+"��������Ŀ"+gPB_OFF
    		// ---------------- MS 07.04.01
