...
?? padr(cStr,44)
B_OFF
?? space(nPomak-44),gPB_ON+"��������������������������������"+gPB_OFF
...
nStavki:=LEN(aKol)
nRedova:=7
cRIK:=SPACE(5)  // razmak izme�u kolona
