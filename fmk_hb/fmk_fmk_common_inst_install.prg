...
fwrite(nH,"cls"+NL)
if cMedij>"B"
fwrite(nH,"echo Stavite ZIP/CD u ure�aj i pritisnite neku tipku"+NL)
else
...
fwrite(nH,"cls"+NL)
if cMedij>"B"
fwrite(nH,"echo Stavite USB u ure�aj i pritisnite neku tipku radi pregleda sadrzaja"+NL)
else
...
fwrite(nH,"cls"+NL)
if cMedij>"B"
  fwrite(nH,"echo Stavite USB u ure�aj i pritisnite neku tipku za pocetak arhiviranja"+NL)
  else
...
for i:=1 to nPrograma
  ...
  if cProg&cpom=="D"                    //       ������� !! master program
