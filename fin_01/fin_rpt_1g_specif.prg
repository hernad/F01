...
fin_cre_pom( nil, __par_len)  // kreiraj pomocnu bazu
...
//   @ m_x+6, m_y+2 SAY "pocetnom stanju tekuce godine? (D/N)" GET cPDVal   PICT "@!" VALID cPDVal$"DN"
  ...
  // dovoljno je unijeti definiciju za posljednju godinu u kojoj je kori�ten
  ...
  StKart(,.t.,iif(!empty(cMjesto),{|| Mjesto(cMjesto)}, NIL ))       // priprema bazu POM.DBF - izvje�taj otv.stavke
